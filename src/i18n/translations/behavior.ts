// Creature Behavior section keys.

export const en = {
  sectionBehavior: 'Creature Behavior',
  perceptionRadius: 'Perception radius',
  perceptionAngleDeg: 'Perception angle (°)',
  boidTurnRateDeg: 'Max turn rate (°/s, 0 = off)',
  boidAccelSmoothingTau: 'Steering smoothing (s, 0 = off)',
...
export const es: typeof en = {
  ...
  boidTurnRateDeg: 'Tasa máx. de giro (°/s, 0 = off)',
  boidAccelSmoothingTau: 'Suavizado de dirección (s, 0 = off)',
...
export const fr: typeof en = {
  ...
  boidTurnRateDeg: 'Taux de virage max (°/s, 0 = désact.)',
  boidAccelSmoothingTau: 'Lissage de direction (s, 0 = désact.)',
