...
const en = {
  ...
  multicolorCount: 'Multicolor boid count',
  goldCount: 'Gold boid count',
  redCount: 'Red boid count',
  blueCount: 'Blue boid count',
  ...
  interspeciesAvoidWeight: 'Inter-species avoidance weight',
  interspeciesAvoidRadius: 'Inter-species avoidance radius',
  ...
  followCamModeLabel: 'Creature view',
  followCamModeOff: 'Off (free orbit)',
  followCamModeOrbit: 'Follow selected (orbit-lock)',
  showCreatureInspectorLabel: 'Creature inspector HUD',
  ...
  showRenderingStatsLabel: 'Show rendering stats',
  enableDiagnosticsCaptureLabel: 'Enable diagnostics capture',
  downloadDiagnosticsButton: 'Download diagnostics',
  clearDiagnosticsButton: 'Clear diagnostics',
  diagnosticsDownloaded: 'Diagnostics downloaded ✅',
  diagnosticsNoData: 'No diagnostics captured yet',
  ...
  galleryPredator: 'Predator (hawk)',
  galleryNormal: 'Normal boid',
  galleryMulticolor: 'Multicolor boid',
  galleryGold: 'Gold boid',
  galleryRed: 'Red boid',
  galleryBlue: 'Blue boid',
...
const es: TranslationDict = {
  ...
  boidCount: 'Cantidad de boids',
  multicolorCount: 'Cantidad de boids multicolor',
  goldCount: 'Cantidad de boids dorados',
  redCount: 'Cantidad de boids rojos',
  blueCount: 'Cantidad de boids azules',
  predatorCount: 'Cantidad de depredadores',
  monsterCount: 'Cantidad de monstruos',
  horseCount: 'Cantidad de caballos',
  ...
  interspeciesAvoidWeight: 'Peso de evitación entre especies',
  interspeciesAvoidRadius: 'Radio de evitación entre especies',
  ...
  sectionCamera: 'Cámara',
  sectionDiagnostics: 'Diagnósticos',
  ...
  followCamModeLabel: 'Vista de criatura',
  followCamModeOff: 'Desactivado (órbita libre)',
  followCamModeOrbit: 'Seguir seleccionada (órbita fija)',
  showCreatureInspectorLabel: 'HUD inspector de criatura',
  ...
  showRenderingStatsLabel: 'Mostrar estadísticas de renderizado',
  enableDiagnosticsCaptureLabel: 'Activar captura de diagnósticos',
  downloadDiagnosticsButton: 'Descargar diagnósticos',
  clearDiagnosticsButton: 'Borrar diagnósticos',
  diagnosticsDownloaded: 'Diagnósticos descargados ✅',
  diagnosticsNoData: 'Aún no hay diagnósticos capturados',
  ...
  galleryPredator: 'Depredador (halcón)',
  galleryNormal: 'Boid normal',
  galleryMulticolor: 'Boid multicolor',
  galleryGold: 'Boid dorado',
  galleryRed: 'Boid rojo',
  galleryBlue: 'Boid azul',
...
const fr: TranslationDict = {
  ...
  multicolorCount: 'Nombre de boids multicolores',
  goldCount: 'Nombre de boids dorés',
  redCount: 'Nombre de boids rouges',
  blueCount: 'Nombre de boids bleus',
  predatorCount: 'Nombre de prédateurs',
  monsterCount: 'Nombre de monstres',
  horseCount: 'Nombre de chevaux',
  ...
  interspeciesAvoidWeight: 'Poids d\'évitement inter-espèces',
  interspeciesAvoidRadius: 'Rayon d\'évitement inter-espèces',
  ...
  followCamModeLabel: 'Vue créature',
  followCamModeOff: 'Désactivé (orbite libre)',
  followCamModeOrbit: 'Suivre la sélection (orbite verrouillée)',
  showCreatureInspectorLabel: 'ATH inspecteur de créature',
  ...
  showRenderingStatsLabel: 'Afficher les statistiques de rendu',
  enableDiagnosticsCaptureLabel: 'Activer la capture de diagnostics',
  downloadDiagnosticsButton: 'Télécharger les diagnostics',
  clearDiagnosticsButton: 'Effacer les diagnostics',
  diagnosticsDownloaded: 'Diagnostics téléchargés ✅',
  diagnosticsNoData: 'Aucun diagnostic capturé pour le moment',
  ...
  galleryPredator: 'Prédateur (faucon)',
  galleryNormal: 'Boid normal',
  galleryMulticolor: 'Boid multicolore',
  galleryGold: 'Boid doré',
  galleryRed: 'Boid rouge',
  galleryBlue: 'Boid bleu',
