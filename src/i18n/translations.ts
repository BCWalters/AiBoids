...
const en = {
  ...
  parrotReviewHoverLabel: 'Parrot review hover mode',
...
const es: TranslationDict = {
  ...
  parrotReviewHoverLabel: 'Modo de revisión flotante del loro',
...
const fr: TranslationDict = {
  ...
  parrotReviewHoverLabel: 'Mode revue perroquet en vol stationnaire',
